...
inline_keyboard_types = {
    ...
    edit_address_keyboard: {
        ...
        "cy": {
            1: "Қайердан манзилини таҳрирлаш",
            2: "Қайердан геолокациясини таҳрирлаш",
            3: "Қайерга манзилини таҳрирлаш",
            4: "Қайерга геолокациясини таҳрирлаш",
            5: "Ортга",
        },
        "ru": {
    ...
    paginate_keyboard: {
        "uz": ["E'lonni yopish", "E'lonni qayta ochish"],
        "cy": ["Еълонни ёпиш", "Еълонни қайта очиш"],
        "ru": ["Закрыть объявление", "Повторно открыть объявление"],
